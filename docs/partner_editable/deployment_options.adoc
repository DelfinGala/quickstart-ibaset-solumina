...
This Quick Start installs the latest version of the Solumina environment on an Amazon EC2 cluster running CentOS 7 (x86_64) with Hardware Virtual Machine (HVM) using Amazon EKS for container orchestration.